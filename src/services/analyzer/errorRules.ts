...
export interface ErrorRule {
    /**
     * A regex pattern to match against the raw error output.
     */
    pattern: RegExp;
    
    /**
     * A function that returns the analysis based on the matched groups (if any).
     */
    analyze: (match: RegExpMatchArray) => ErrorAnalysis;
}
