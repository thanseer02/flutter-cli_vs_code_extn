    ...
    static parse(stdout: string): DoctorCategory[] {
        ...
        for (const line of lines) {
            ...
            if (match) {
                ...
                let status: DoctorStatus = 'success';
                if (symbol === '!') {
                    status = 'warning';
